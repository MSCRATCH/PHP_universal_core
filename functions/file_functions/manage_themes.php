...
function get_activated_theme(mysqli $db) {
$active_theme = 1;
$default_theme = "default_theme";
$default_theme_stylesheet = "default.css";
...
$stmt->fetch();
$stmt->close();
return ['theme_key' => $theme_key, 'theme_stylesheet' => $theme_stylesheet];
} else {
return ['theme_key' => $default_theme, 'theme_stylesheet' => $default_theme_stylesheet];
}
}
...
if (! file_exists($full_path . '/layout.php') && ! file_exists($full_path . '/layout_profile.php') && ! file_exists($full_path . '/layout_secondary.php') && ! file_exists($full_path . '/layout_tertiary.php')) {
continue;
}
