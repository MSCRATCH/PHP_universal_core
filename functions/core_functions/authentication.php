...
if (isset($_SESSION['logged_in']['user_level']) && $_SESSION['logged_in']['user_level'] === "administrator" or isset($_SESSION['logged_in']['user_level']) && $_SESSION['logged_in']['user_level'] === "moderator" or isset($_SESSION['logged_in']['user_level']) && $_SESSION['logged_in']['user_level'] === "user" or isset($_SESSION['logged_in']['user_level']) && $_SESSION['logged_in']['user_level'] === "not_activated") {
return true;
} else {
return false;
}
