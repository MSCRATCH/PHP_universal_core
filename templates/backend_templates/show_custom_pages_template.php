...
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['show_custom_pages_template_text']);?></p>
</div>
...
<div class="wrapper_title"><h3><i class="fa-solid fa-folder"></i> <?php echo sanitize_1($text_templates['show_custom_pages_template_no_entries_title']);?></h3></div>
<div class="wrapper_content">
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['show_custom_pages_template_no_entries_text']);?></p>
</div>
</div>
<?php } ?>
