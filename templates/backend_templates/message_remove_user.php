...
<link rel="stylesheet" href="<?= BASE_URL ?>themes/backend_theme/css/backend.css" media="all" type="text/css">
...
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['message_remove_user_text']);?> <?php echo sanitize_1($username_remove_form);?>?</p>
</div>
...
<button class="btn btn--btn_dng" type="submit" name="remove_user_confirm"><?php echo sanitize_1($text_templates['message_remove_user_btn_confirm']);?></button>
</form>
<a class="btn btn--btn_primary" href="<?= BASE_URL ?>users"><?php echo sanitize_1($text_templates['message_remove_user_btn_cancel']);?></a>
</div>
</div>
</div>
