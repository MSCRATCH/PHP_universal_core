...
<?php $number_of_user_activity_log_entries = number_of_user_activity_log_entries($db, $user['user_id']);  ?>
<div class="template_wrapper_flex">
<div class="wrapper_title">
<ul>
<li class="list_style_none"><a class="b_link" target="_blank" href="<?= BASE_URL ?>profile/<?php echo sanitize_1($user['username']);?>"><?php echo sanitize_3($user['username']);?></a></li>
<li class="list_style_none"><a class="b_link" target="_blank" href="<?= BASE_URL ?>show_user_activity_log/<?php echo sanitize_1($user['user_id']);?>"><?php echo sanitize_1($text_templates['users_template_show_user_activity_log']);?> [<?php echo sanitize_1($number_of_user_activity_log_entries);?>]</a></li>
...
<?php if ($user['email_is_verified'] === 1) { ?>
...
<div class="wrapper_title"><h3><?php echo sanitize_1($text_templates['users_template_no_entries_title']);?></h3></div>
<div class="wrapper_content">
<p class="paragraph_mtb"><?php echo sanitize_1($text_templates['users_template_no_entries_text']);?></p>
</div>
</div>
<?php }?>
