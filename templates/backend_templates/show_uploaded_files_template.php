...
<div class="wrapper_title"><h3><i class="fa-solid fa-cloud"></i> <?php echo sanitize_1($text_templates['show_uploaded_files_template_no_files_title']);?></h3></div>
<div class="wrapper_content">
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['show_uploaded_files_template_no_files_text']);?></p>
</div>
</div>
<?php } ?>
