...
<div class="btn_row">
<button class="btn btn--btn_primary" type="submit" name="backend_login"><?php echo sanitize_1($text_templates['backend_login_template_btn']);?></button>
</form>
<a class="btn btn--btn_dng" href="<?php echo BASE_URL;?><?php echo sanitize_1($settings['default_start_page']);?>"><?php echo sanitize_1($text_templates['backend_login_template_btn_return']);?></a>
</div>
</div>
</div>
</div>
