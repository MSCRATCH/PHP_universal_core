...
<div class="wrapper_title"><h3><?php echo sanitize_1($text_templates['request_log_template_no_entries_title']);?></h3></div>
<div class="wrapper_content">
<p class="paragraph_mtb"><?php echo sanitize_1($text_templates['request_log_template_no_entries_text']);?></p>
</div>
</div>
<?php } ?>
