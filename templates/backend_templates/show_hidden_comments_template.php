...
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['show_hidden_comments_template_text']);?></p>
</div>
...
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['show_hidden_comments_template_viewed']);?></p>
<?php } else { ?>
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['show_hidden_comments_template_not_viewed']);?></p>
<?php } ?>
</div>
</div>
<?php } ?>
...
<div class="wrapper_title"><h3><i class="fa-solid fa-comment"></i> <?php echo sanitize_1($text_templates['show_hidden_comments_template_no_entries_title']);?></h3></div>
<div class="wrapper_content">
<p class="paragraph_nm"><?php echo sanitize_1($text_templates['show_hidden_comments_template_no_entries_text']);?></p>
</div>
</div>
<?php } ?>
