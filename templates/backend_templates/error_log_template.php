...
<p class="paragraph_mtb"><?php echo sanitize_1($text_templates['error_log_template_text_error_log']);?></p>
</div>
</div>
...
<div class="wrapper_title"><h3><?php echo sanitize_1($text_templates['error_log_template_title_no_entries']);?></h3></div>
<div class="wrapper_content">
<p class="paragraph_mtb"><?php echo sanitize_1($text_templates['error_log_template_text_no_entries']);?></p>
</div>
</div>
<?php } ?>
