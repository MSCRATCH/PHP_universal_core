...
<div class="btn_row">
<button class="btn btn--btn_primary" type="submit" name="register"><?php echo sanitize_1($text_templates['register_template_btn_register']);?></button>
</form>
<a class="btn btn--btn_dng" href="<?php echo BASE_URL;?><?php echo sanitize_1($settings['default_start_page']);?>"><?php echo sanitize_1($text_templates['register_template_btn_return_to_homepage']);?></a>
</div>
</div>
</div>
