...
<div class="btn_row">
<button class="btn btn--btn_primary" type="submit" name="login"><?php echo sanitize_1($text_templates['login_template_btn_login']);?></button>
</form>
<a class="btn btn--btn_dng" href="<?php echo BASE_URL;?><?php echo sanitize_1($settings['default_start_page']);?>"><?php echo sanitize_1($text_templates['login_template_btn_return_to_home_page']);?></a>
</div>
</div>
</div>
