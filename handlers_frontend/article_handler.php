...
$result_save_comment = save_comment($db, $feature_flags, $text_functions, $blog_comment_form, $user_id_article_handler, $blog_article_url_get);
...
$result_hide_comment = hide_comment($db, $feature_flags, $blog_comment_id_form, $user_id_article_handler, $blog_article_url_get);
...
$result_restore_comment = restore_comment($db, $feature_flags, $blog_comment_id_form, $user_id_article_handler, $blog_article_url_get);
...
$result_remove_comment = remove_comment($db, $feature_flags, $blog_comment_id_form, $user_id_article_handler, $blog_article_url_get);
...
$layout = $activated_theme['layout_config']['layouts']['article_handler'] ?? 'layout';
$template_directory = $activated_theme['template_config']['templates']['template_directory'] ?? 'frontend_templates';
$template = $activated_theme['template_config']['templates']['article_handler'] ?? 'article_template';
